...
import Movement.*;
import Errors.*;
import Interfaces.AnalogPrint;

public class TheGist implements AnalogPrint{	
	...
	public static void main(String[] args) {
		...
		String s11 = sniff.getName().getName();
		String s22 = xemyl.getName().getName();
		AnalogPrint output = (s1, s2) -> s1 + " и " + s2 + " объеденяют усилия в попытке найти персонажа " + moomintroll.getName().getName();
		System.out.println(output.print(s11, s22));
